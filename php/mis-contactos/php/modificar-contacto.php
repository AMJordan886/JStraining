...
if($num_regs==1){
    //Si la foto está vacia asignamos el valor del boton oculto de la foto que tiene el valor anterior
    //a la busqueda, sino subo la nueva foto y reemplazo el valor
