...
<div>
    ...
    <input type="number" id="telefono" class="cambio" name="telefono_txt" title="Tu telefono" placeholder="Escribe tu telefono" value="<?php echo $registro_contacto["telefono"] ?>" required>
</div>
<div>
